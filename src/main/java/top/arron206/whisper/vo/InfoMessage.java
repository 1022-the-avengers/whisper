...
public class InfoMessage {
    ...
    private UserInformation userMessage;
    ...
    public InfoMessage(String message, Map<Object, Object> unreadMessages, Map<Object, Object> unreadNum, UserInformation userMessage, LinkMessage linkMessage) {
    ...
    public UserInformation getUserMessage() {
        return userMessage;
    }

    public void setUserMessage(UserInformation userMessage) {
        this.userMessage = userMessage;
    }
